package com.apilrijal.controller;

import com.apilrijal.model.Song;
...
public class SinglyLinkedPlaylistManager {
    ...
    public void addFavoriteSong(Song newSong) {
        ...
        if(head == null){
            ...
            System.out.println(newSong.getTitle() + "Added to the playlist as first song");
        }
    ...
    public void removeFavoriteSong(int index) {
        ...
        if (index == 1) {
            System.out.println("Removed: " + head.song.getTitle());
    ...
    public void displayFavoriteSongs() {
        ...
        if(head == null){
            System.out.println("Playlist is emoty");
            return;
        }
